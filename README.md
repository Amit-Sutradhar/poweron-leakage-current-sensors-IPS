...
1. ESP32 communicates with ADS1115 via I2C
2. TCA9548A selects the active I2C channel
3. ADS1115 reads analog voltage (high resolution mode)
4. Voltage is mapped to leakage current using a calibration table
5. Data is printed on Serial Monitor
...
**Amit Sutradhar**
IoT | Embedded Systems | Water Monitoring Systems
...
* 🔥 Add **GitHub project structure (folders + naming)**
* 🔥 Create a **professional repo with images + circuit diagram**
* 🔥 Add **PCB + KiCad files section** for your startup use
